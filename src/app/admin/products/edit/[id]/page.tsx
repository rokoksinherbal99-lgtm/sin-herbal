  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (p) {
          setForm({ name: p.name, slug: p.slug, description: p.description, price: String(p.price), stock: String(p.stock), images: p.images, categoryId: p.categoryId || "", productType: p.productType || "", manufacturer: p.manufacturer || "PR UD Putra Bintang Timur, Malang", featured: p.featured });
        } else {
