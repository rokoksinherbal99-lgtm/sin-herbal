          ...
          <div className="grid gap-10 md:grid-cols-4">
            <div className="md:col-span-1">
              ...
              <div className="mt-5 flex items-center gap-3">
                <a href={`https://wa.me/${s.wa_phone}`} target="_blank" className="flex h-9 w-9 items-center justify-center rounded-sm border border-[#D5E0D3] bg-white text-[#ABC1A7] transition hover:border-[#ABC1A7] hover:bg-[#D5E0D3] hover:text-[#2C4C3B]" aria-label="WhatsApp">
                ...
                <a href="https://instagram.com/sin_herbal" target="_blank" className="flex h-9 w-9 items-center justify-center rounded-sm border border-[#D5E0D3] bg-white text-[#ABC1A7] transition hover:border-[#ABC1A7] hover:bg-[#D5E0D3] hover:text-[#2C4C3B]" aria-label="Instagram">
                ...
                <a href="https://www.youtube.com/@SinHerbal" target="_blank" className="flex h-9 w-9 items-center justify-center rounded-sm border border-[#D5E0D3] bg-white text-[#ABC1A7] transition hover:border-[#ABC1A7] hover:bg-[#D5E0D3] hover:text-[#2C4C3B]" aria-label="YouTube">
