...
const slides = [
  ...
  {
    id: 2,
    title: "Kopi Mega Remeng",
    subtitle: "Khasiat Herbal dalam Setiap Tegukan",
    description: "Kopi herbal dengan campuran rempah pilihan yang menyehatkan dan nikmat.",
    cta: "Lihat Koleksi",
    href: "/products?cat=kopi-mega-remeng",
